...
(
    ...
    is_alerted_for_confirming_settlement               tinyint(1) default 1 comment '決裁確認 アラートフラグ',
    ...
    is_alerted_for_waiting_confirming_settlement       tinyint(1) default 1 comment '決裁確認待ち リマインドアラートフラグ',
...
(
    ...
    is_deleted tinyint(1) default NULL comment '削除フラグ',
...
(
    ...
    subject                          varchar(50)   NOT NULL comment '表題',
    store_g_cd                       varchar(9)    NOT NULL comment '店舗グループコード',
    store_g_nm                       varchar(40)   NOT NULL comment '店舗グループ名',

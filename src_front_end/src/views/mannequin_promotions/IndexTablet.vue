      ...
      <b-container fluid class="request-body customScrollBar" ref="mainView">
        ...
        <collapse>
          ...
          <template v-slot:collapse-body>
            ...
            <b-row class="px-4 py-1 mt-3">
              <div :class="['tablet_xxl mannequinTable',{impletment_store: isTabletDevice}]">
                <table>
                  <thead>
                  <tr>
                    <th>実施店舗</th>
                    <th>実施日</th>
                    <th class="mannequinTableActions" align="left" v-if="!isTabletDevice">
                ...
                />
                    ...
                    <td align="left" class="mannequinTableActions" v-if="!isTabletDevice">
        ...
        <Collapse>
          ...
          <template slot="collapse-body">
            ...
            <b-row class="px-4 py-1 mt-3">
              ...
              <div class="tablet_lg" v-if="item.requestModel.paymentMethod == 'その他'">
                <InputSskf

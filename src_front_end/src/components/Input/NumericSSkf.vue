...
export default {
  ...
  methods: {
    ...
    onBlurHandler (e) {
      this.$emit('blur', e)
      if(this.valueNumber === undefined || this.valueNumber === null || isNaN(this.valueNumber)){
        this.amount = null
      }else{
        this.amount = this.format(this.valueNumber)
      }
    ...
    update (value) {
      if(value === null || value === undefined || value === "" || isNaN(value)){
        this.$emit('input', value == "" || isNaN(value) ? undefined : value);
        console.log(value)
      }else{
    ...
    unformat (value) {
      if(value == 0 || value === undefined || value === null || value === ""){
        ...
        let str = accounting.unformat(toUnformat, this.decimalSeparatorSymbol);
